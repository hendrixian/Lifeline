                ...
                <div class="mt-8">
                    ...
                    <div
                        ...
                        <p class="text-sm text-slate-800 text-center">
                            ...
                            levels,
                            such as Divisions, Cities, and Townships.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-center items-center gap-5 my-5">
                ...
                <div class="p-3 flex gap-3 justify-center items-center">
                    ...
                    <div class="flex flex-col gap-1">
                        <h3 class="text-slate-800 font-bold text-[18px]">EDMS Team</h3>

                        <div>
                            <!-- Email Link -->
                            <a href="mailto:edms@blah.com" target="_blank">
                                <button class="btn btn-sm btn-square hover:bg-slate-900 hover:text-white">
                                    <i class="fa-solid fa-envelope"></i>
                                </button>
                            </a>
                            <!-- Address Link -->
                            <a href="https://www.google.com/maps?q=University+of+Information+Technology+UIT" target="_blank">
                                <button class="btn btn-sm btn-square hover:bg-slate-900 hover:text-white">
                                    <i class="fa-solid fa-map-marker-alt"></i>
                                </button>
                            </a>
                            <!-- Phone Number Link -->
                            <a href="tel:+8801234567890" target="_blank">
                                <button class="btn btn-sm btn-square hover:bg-slate-900 hover:text-white">
