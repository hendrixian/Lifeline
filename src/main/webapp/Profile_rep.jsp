   ...
   if (loggedInUser == null) {
     ...
     try 
    {
    		...
    		while(rs.next())
    		{
		          ...
		          Type = rs.getString("UserType");                  UserCities = rs.getString("City");
     ...
     String query123  = "SELECT * FROM myanmar WHERE Cities = '"+UserCities+"'";
     ...
     try 
    	{
    		...
    		while(rs.next())
    		{
			          ...
			          String query2 = "SELECT * FROM registrationinfo WHERE Username = '"+loggedInUser+"'";
