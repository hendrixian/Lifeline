...
<%
    ...
    System.out.println("LoggedInUser: " + loggedInUser);  // This will print the value to the server logs
    ...
    query = "SELECT * FROM user WHERE Username = '"+loggedInUser+"'";
    ...
    String queryQ = "SELECT * FROM contributions WHERE LocationUsername = '"+loggedInUser+"'";
    Statement stmtQ;
    String Verified1 = null;
    try
    {
        stmtQ = con.createStatement();
        ResultSet rsQ = stmtQ.executeQuery(queryQ);
        while(rsQ.next())
        {
            Verified = rsQ.getString("LocationUsername");
    ...
    queryQ = "SELECT ShelterName, Amount, Date FROM contributions WHERE LocationUsername = '"+loggedInUser+"'";
    ...
    try {
        ...
        while (rsQ.next()) {
            String[] row = {
                    rsQ.getString("ShelterName"),
                    rsQ.getString("Amount"),
                    rsQ.getString("Date")
            };
    ...
    try
    {
        ...
        while(rs.next())
        {
            ...
            String LLocUsername = rs.getString("Zipcode");
            String LLocVerified = null;

            String query2 = "SELECT * FROM user WHERE Username = '"+loggedInUser+"'";
    ...
    Stack<String>PostTownships= new Stack<String>();
    Stack<String>PostCities= new Stack<String>();
    Stack<String>PostDivisions= new Stack<String>();
    ...
    try
    {
        ...
        while(rs.next())
        {
            ...
            String query1 = "SELECT * FROM myanmar where Cities = '"+PostLocation1+"'";

            String Divisions = null;
            String Cities = null;
            String Townships = PostLocation1;
            ...
            try
            {
                ...
                while(rs1.next())
                {
                    Divisions = rs1.getString("Divisions");
                    Cities = rs1.getString("Cities");
                }
            ...
            PostTownships.push(Townships);
            PostCities.push(Cities);
            PostDivisions.push(Divisions);
    ...
    <div class="my-container">
        ...
        <div class="navbar bg-base-100 lg:hidden bg-amber-500 min-h-[100px]">
            ...
            <div class="navbar-end">
                <a href="logout.jsp" class="text-white hover:text-[#F17829] transition duration-300">
                    <i class="fa-solid fa-right-from-bracket"></i>
                </a>
            </div>
        </div>
...
<div class="my-container grid grid-cols-1 lg:flex gap-5 p-5">
    ...
    <div class="static lg:sticky top-0">
        <div class="sticky top-5 flex flex-col gap-1 justify-center items-center p-5 shadow-lg rounded-lg min-w-[280px]">
            ...
            <div class="relative inline-block">
                <img onclick="profile_img_modal.showModal()" class="cursor-pointer rounded-full w-[250px] h-[250px] mt-3 border-4 border-yellow-500" src="<%=Image%>" alt="profile picture">

                <!-- Green Dot for Active Status -->
                <div class="absolute bottom-4 right-10 w-6 h-6 bg-green-500 rounded-full border-2 border-white"></div>
            </div>
            ...
            <h2 class="mb-3 text-slate-600">Contribution Points:= <%=LocName.size()%></h2>
        </div>
    </div>
    ...
    <div class="shadow-lg rounded-lg p-5 grow">
        <!-- User description -->
        <div class="bg-gray-100 p-3 lg:p-5 rounded-lg mb-5 border-2 border-yellow-500 glow-red">
            <h1 class="font text-center text-[20px] mb-2">User Description</h1>
        ...
        <div class="flex flex-col items-center gap-5">
            <a href="AddPost.jsp"><button class="btn btn-warning px-8 py-4 w-full hover:bg-amber-500 text-black font-semibold relative blingy-button">Add Post <span class="absolute top-0 left-0 w-full h-full rounded-lg"></span></button></a>
        ...
        <div>
            <div class="divider"></div>
            <div class="bg-gray-100 p-3 lg:p-5 rounded-lg mb-5 border-4 border-yellow-500">
                <h1 class="text-slate-600 font-bold text-[20px] text-center">User Contribution History</h1>
            ...
            <div class="flex flex-col gap-5 overflow-hidden my-5">
                ...
                <div data-aos="fade-right" class="bg-[#d9d9d9] p-3 md:p-5 rounded-xl">
                    ...
                    <div class="my-2 text-[15px] flex gap-1 items-center">
                        <i class="fa-solid fa-location-dot"></i>
                        <div class="badge badge-ghost"><%=PostTownships.pop()%></div>
                        <div class="badge badge-ghost"><%=PostCities.pop()%></div>
                        <div class="badge badge-ghost"><%=PostDivisions.pop()%></div>
                    </div>
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                        <div class="grid grid-cols-2 lg:flex gap-2">
                            ...
                            <img onclick="<%=take1%>" class="center-cropped max-h-[200px] cursor-pointer lg:w-[50%] rounded-xl w-full"
                            ...
                            <img onclick="<%=take3%>" class="center-cropped max-h-[200px] cursor-pointer lg:w-[50%] rounded-xl w-full"
                        ...
                        <div class="post-description flex flex-col justify-between">
                            ...
                            <div class="flex justify-end items-center">
                                ...
                                <span onclick="<%=take5%>" class="px-3 py-2 bg-[#F2F2F2] rounded-xl cursor-pointer hover:bg-[#E5E5E5]">See
                                      more</span>
                                <!-- See More Modal -->
